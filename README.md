...
Applications using it allow anyone to validate execution and dispute incorrect results through an [on-chain Machine verifier](https://github.com/cartesi/machine-solidity-step).
...
Licenses vary by component: the Cartesi Machine uses LGPL-3.0; the on-chain Machine verifier, Dave, Rollups Contracts, Rollups Node, and the CLI use Apache-2.0.
